            ...
            <div class="write-post-container"> 
                ...
                <form method="post" autocomplete="off" action="<?=base_url('user/post')?>">
                    ...
                    <div class="post-input-container">
                        <textarea rows="2" name="post" placeholder="What's on your mind, <?php echo $this->session->userdata('username');?>?"></textarea>
                                ...
                                <div class="btn-group1 btn-group" >
                                    ...
                                    <ul class="dropdown-menu1 dropdown-menu">
                                        ...
                                        <form method="post" autocomplete="off" action="<?=base_url('user/feedback/'.$row->id.'/'.$row->post_id)?>">
                                            ...
                                            <textarea rows="2" name="post" placeholder="What's your bugs / feedback about the post, <?php echo $this->session->userdata('username');?>?"></textarea>
