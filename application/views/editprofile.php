    ...
    <div class="container">
        ...
        <div class="container-fluid">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                                    <div  class="post_status">
                                                        <a href='#' style="border: 1px solid #AED67A;; background-color: #576B3D; color: #fff; text-decoration: none; font-size: 10px; padding: 7px 15px; border-radius: 10px;">
                                                            Approved
                                                        </a>
                                                    </div>
                                            <?php 
            ...
            <div class="setting">
                 ...
                 <form method="post" autocomplete="off" action="<?=base_url('user/changeusername')?>">
        ...
        <div class="main-content">
            ...
            <div class="update-form">
                <form action="<?=base_url('user/insertimage')?>" method="post" enctype="multipart/form-data">
                    <div class="mt-5">
